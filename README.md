...
- [**Internal**](./internal): the shared tools and API used by **Mithril** crates.
  ...
  - [**Mithril cardano-node-internal-database**](./internal/cardano-node/mithril-cardano-node-internal-database): mechanisms to read and hash the files of a **Cardano node** internal database, used by **Mithril network** nodes.
