...
- Cardano database certification:

  - Creation of two separate archives, one for the immutable files and another for the ancillary files.
  - Added a signed manifest file, which contains the list of all files in the archive and their sha256 hashes, to the ancillary archive.
