...
impl InternalStaticticsSender {
    ...
    pub async fn add_statistics(
        ...
        if include_ancillary {
            self
                .aggregator_client
                .post_content(AggregatorRequest::IncrementCardanoDatabaseSnapshotAncillaryFilesRestoredStatistic)
                .await?;
        };
        ...
        self
            .aggregator_client
            .post_content(AggregatorRequest::IncrementCardanoDatabaseSnapshotImmutableFilesRestoredStatistic {
    ...
    async fn add_statistics_do_not_increments_immutable_files_restored_when_no_immutable_files_restored() {
        ...
        let client = CardanoDatabaseClientDependencyInjector::new()
            .with_aggregator_client_mock_config(|http_client| {
                http_client
                .expect_post_content()
                .with(predicate::function(|req| matches!(req, AggregatorRequest::IncrementCardanoDatabaseSnapshotImmutableFilesRestoredStatistic { .. })))
                .never();
