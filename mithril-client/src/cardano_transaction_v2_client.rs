...
//!
//! println!("Cardano transaction snapshot hash={}, epoch={}, block_number_signed={}", cardano_transaction_snapshot.hash, cardano_transaction_snapshot.epoch, cardano_transaction_snapshot.block_number_signed);
//! #    Ok(())
//! # }
//! ```
//!
