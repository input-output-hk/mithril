...
describe("Stake formatting", () => {
  it.each([
    ...
    "formatting party id remove all but the 10 first and the last 5 characters",
    (partyId, expected) => {
  ...
  it.each([
    ...
    [
      "pool1zmtm8yef33z22n7x4nn0kvv9xpzjn7x4nn0kvv9xpzjuj7725p9y9m5t960g5qy51ua",
      "pool1zmtm8…y51ua",
    ],
    ...
    "formatting party id remove all but the 10 first and the last 5 characters even for non usual length",
    (partyId, expected) => {
      expect(formatPartyId(partyId)).toEqual(expected);
    },
  );
