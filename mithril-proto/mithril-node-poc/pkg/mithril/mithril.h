 ...
 */
typedef struct MerkleTreeCommitment_MTValue_C_____H MerkleTreeCommitment_MTValue_C_____H;
...
typedef MerkleTreeCommitment_MTValue_C_____H *MerkleTreeCommitmentPtr;
...
int64_t generate_avk(ClosedKeyRegPtr key_reg, MerkleTreeCommitmentPtr *mk_tree);
