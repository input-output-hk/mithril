module github.com/input-output-hk/mithril/mithril-proto/mithril-node-poc
...
require (
	github.com/Pantani/errors v1.0.0 // indirect
	github.com/Pantani/logger v1.0.0 // indirect
	github.com/Pantani/request v1.0.2 // indirect
