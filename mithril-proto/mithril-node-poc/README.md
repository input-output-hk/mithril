...
```shell
$ cd mithril-proto/mithril-node-poc
$ make mlib
```
...
```
$ cd ../../
$ docker build -t mithril/mithril-node-poc -f mithril-proto/mithril-node-poc/Dockerfile . && docker run -it --entrypoint /bin/bash --rm  mithril/mithril-node-poc
```
