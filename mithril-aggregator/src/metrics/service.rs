...
build_metrics_service!(
    ...
    artifact_detail_cardano_block_transactions_total_served_since_startup:MetricCounterWithLabels(
        "mithril_aggregator_artifact_detail_cardano_block_transactions_total_served_since_startup",
        "Number of Cardano block transactions artifact details served since startup on a Mithril aggregator node",
        &[CLIENT_ORIGIN_TAG_LABEL, CLIENT_TYPE_LABEL]
    ),
