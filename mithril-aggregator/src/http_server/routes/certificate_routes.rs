...
pub fn routes(
    ...
    certificate_certificates(router_state)
        .or(certificate_certificate_genesis(router_state))
...
fn certificate_certificate_genesis(
    router_state: &RouterState,
) -> impl Filter<Extract = (impl warp::Reply,), Error = warp::Rejection> + Clone {
    warp::path!("certificate" / "genesis")
        ...
        .and_then(handlers::certificate_certificate_genesis)
}
...
mod handlers {
    ...
    pub async fn certificate_certificate_genesis(
...
mod tests {
    ...
    async fn test_certificate_certificate_genesis_get_ok() {
        ...
        let returned_genesis: CertificateMessage =
    ...
    async fn test_certificate_when_error_on_retrieving_certificate_genesis_returns_ko_500() {
        ...
        let mut message_service = MockMessageService::new();
        message_service
            .expect_get_lastest_genesis_certificate_message()
