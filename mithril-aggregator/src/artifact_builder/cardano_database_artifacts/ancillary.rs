...
impl AncillaryArtifactBuilder {
    ...
    pub async fn create_and_upload_archive(
        ...
        // TODO: implement retry mechanism (builder responsability on upload)
        for uploader in &self.uploaders {
            ...
            match location {
                ArtifactLocation::URI(uri) => {
                    locations.push(AncillaryLocation::CloudStorage {
                        uri: uri.to_string(),
                    });
                }
            }
...
mod tests {
    ...
    // case when no uploaders: Return None or error?
    #[tokio::test]
