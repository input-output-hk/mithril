...
mod tests {
    ...
    fn insert_certificate_records<T: Into<CertificateRecord>>(
    ...
    fn projection() {
        ...
        assert_eq!(
            ...
            c.parent_certificate_id as parent_certificate_id, \
            c.message as message, \
            c.signature as signature, \
            c.aggregate_verification_key as aggregate_verification_key, \
            c.epoch as epoch, \
            ...
            c.signers as signers, \
            c.initiated_at as initiated_at, \
            c.sealed_at as sealed_at"
                .to_string(),
