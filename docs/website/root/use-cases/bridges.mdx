...
Proofs are generated approximately every 30 blocks, with certification operating around 100 blocks behind the chain tip to ensure finality. Bridge teams should factor this into their finality model and user-facing expectations around transfer latency.
