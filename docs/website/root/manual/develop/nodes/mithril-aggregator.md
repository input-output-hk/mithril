...
| `ancillary_files_signer_config`                                  | -                                                                  |          -           | `ANCILLARY_FILES_SIGNER_CONFIG`                                                                           | Configuration of the ancillary files signer, **IMPORTANT**: The cryptographic scheme used is ED25519                                                  | -                                             | `{ "type": "secret-key", "secret_key": "136372c3138312c3138382c3130352c3233312c3135" }` |                        -                        |
