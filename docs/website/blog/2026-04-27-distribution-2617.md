...
⚠️ This distribution will reset the `cardano-transaction` database of the signer and the aggregator, and a new full scan of the Cardano chain will be triggered.
...
- **Release process**: upgraded the release process to support synchronization with the Cardano node releases
