...
* The library is throughly tested thanks to:
  ...
  * Tests are run in the [Continuous Integration](https://github.com/input-output-hk/mithril/tree/main/.github/workflowss/ci.yml) process, both for Rust, C and Go parts,
* It is lacking user-facing "Get started" style documentation but the code is properly documented and the [examples/](https://github.com/input-output-hk/mithril/tree/main/mithril-core/examples) directory contains several detailed examples covering the major use cases for the library.
...
* The target architecture has been documented in the [Mithril Architecture](../topologies/mithril-architecture.md) document
...
7. Work on [Mithril Test Lab](../test-lab/mithril-test-lab.md) to build a semi-formal ETE testing solution to validate the protocol's implementation independently of the technology
