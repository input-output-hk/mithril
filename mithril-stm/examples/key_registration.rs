...
//     assert_eq!(party_0_sigs.get_indices().len(), 10);
//     assert_eq!(party_1_sigs.get_indices().len(), 10);
//     assert_eq!(party_2_sigs.get_indices().len(), 10);
//     assert_eq!(party_3_sigs.get_indices().len(), 10);

//     // Different combinations of signatures. Recall that we only need 3 signatures
//     party_0_sigs.set_indices(&party_0_sigs.get_indices()[..2]);
//     party_3_sigs.set_indices(&party_3_sigs.get_indices()[..2]);
