...
mod tests {
    ...
    mod slow {
        use crate::{
            circuits::halo2_ivc::tests::common::asset_readers::{
                load_embedded_following_certificate_in_epoch_asset,
                load_embedded_verification_context_asset,
            },
            proof_system::ivc_halo2_snark::test_support::{
                accumulator_bytes, build_global, build_ivc_setup, wrap_avk, wrap_snark_proof,
            },
        };
        ...
        mod build_next_accumulator {
            ...
            use crate::circuits::halo2_ivc::tests::common::generators::build_asset_generation_setup;
            ...
            fn accepts_valid_proof() {
                ...
                let dual_msm =
                    verify_certificate_proof(&certificate_proof, &step.message, &avk, &setup)
                        .expect("verify_certificate_proof should succeed for valid asset");
                assert!(
                    dual_msm.check(&setup.srs.verifier_params()),
