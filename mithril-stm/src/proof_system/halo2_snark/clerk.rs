use crate::{
    ClosedKeyRegistration, MembershipDigest, Signer, proof_system::AggregateVerificationKeyForSnark,
};
    ...
    proptest! {
        ...
        fn compute_snark_avk(
            ...
            let clerk_from_registration =
                SnarkClerk::new_clerk_from_closed_key_registration(&closed_registration);
